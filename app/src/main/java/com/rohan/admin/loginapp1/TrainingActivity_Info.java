...
public class TrainingActivity_Info extends AppCompatActivity {

    public String info_url = "http://dragon321.esy.es/training_info.php";
    TextView text1,text2,text3,text4,text5,text6;
    ListView list1;
    Button reg_button,pbutton;
    String json;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_training_activity__info);
        ...
        text6 = (TextView) findViewById(R.id.urlname);
        String message4 = getIntent().getStringExtra("url");
        text6.setText(message4);
        ...
        reg_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    {
                        registerBackgroundTask registerBackgroundTask = new registerBackgroundTask(TrainingActivity_Info.this);
        ...
        pbutton= (Button)findViewById(R.id.pdfbutton);
        pbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String pdf = "http://dragon321.esy.es/documents/"+text6.getText().toString(); //YOUR URL TO PDF

                Intent intent = new Intent(TrainingActivity_Info .this,pdfview.class);
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        TrainingActivity_Info.this, personList, R.layout.traininginformation,
    ...
    public class registerBackgroundTask extends AsyncTask<String,Void,String> {
        String register_url = "http://dragon321.esy.es/reg_training.php";
