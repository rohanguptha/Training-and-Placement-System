...
public class PlacementActivity_admin_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placement_activity_admin_info);
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        PlacementActivity_admin_info.this, personList, R.layout.traininginformation,
