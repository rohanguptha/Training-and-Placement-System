...
public class Training_del extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_training_del);

        Name = (EditText)findViewById(R.id.del);
        ...
        public void onClick(View v) {
            ...
            if (networkInfo != null && networkInfo.isConnected()) {
                if (Name.getText().toString().equals(""))
                {
                    ...
                    group.setBackgroundColor(ContextCompat.getColor(Training_del.this, R.color.btn_logut_bg));
                    snack.show();
                }

                else
                {
                    deleteBackgroundTask deleteBackgroundTask = new deleteBackgroundTask(Training_del.this);
...
public class deleteBackgroundTask extends AsyncTask<String,Void,String> {
    String delete_url = "http://dragon321.esy.es/delete_training.php";
    ...
    protected String doInBackground(String... params) {
        ...
        if (method.equals("delete"))
        {
            try {
                ...
                String data = URLEncoder.encode("activity","UTF-8")+"="+URLEncoder.encode(name,"UTF-8");
