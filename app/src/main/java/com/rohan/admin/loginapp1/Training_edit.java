...
public class Training_edit extends AppCompatActivity {
    EditText Activiy_name,time,date;
    Button add_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activiy_name = (EditText)findViewById(R.id.edit_activity);
        time = (EditText)findViewById(R.id.edit_time);
        date = (EditText)findViewById(R.id.edit_date);



        add_button = (Button)findViewById(R.id.edit);
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
...

                    {
                        ...
                        group.setBackgroundColor(ContextCompat.getColor(Training_edit.this, R.color.btn_logut_bg));
                        snack.show();

                    } else {
                        editBackgroundTask editbackgroundTask = new editBackgroundTask(Training_edit.this);
                        editbackgroundTask.execute("edit",Activiy_name.getText().toString(), time.getText().toString(), date.getText().toString());
    ...
    public class editBackgroundTask extends AsyncTask<String,Void,String> {
        String edit_url = "http://dragon321.esy.es/update_training.php";
