...
public class Search_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1 = (TextView) findViewById(R.id.searchrollno);
        String message = getIntent().getStringExtra("rollno");
        ...
        v.execute("verifystudent", text1.getText().toString());
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        Search_Student.this, personList, R.layout.verifystudent_display,
