...
public class Myprofile_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myprofile__student);
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        Myprofile_Student.this, personList, R.layout.verifystudent_display,
